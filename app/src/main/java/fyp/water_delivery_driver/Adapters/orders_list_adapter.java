package fyp.water_delivery_driver.Adapters;
...
import fyp.water_delivery_driver.order_details;
    ...
    public void onBindViewHolder(@NonNull order_list_viewholder holder, int position) {
      ...
      holder.order_detail.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View v) {
              context.startActivity(new Intent(context, order_details.class).putExtra("orderData",new Gson().toJson(orders.get(position))));
          }
      });
    }
